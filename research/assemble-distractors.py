...
BATCHES = [
    ('contemporary-distractors-research.json', 2, 'CONTEMPORARY_DISTRACTOR_SOURCES.md'),
    ('distractor-west-europe.json', 8, 'DISTRACTOR_WEST_EUROPE_SOURCES.md'),
    ...
    ('distractor-brazil-italy.json', 5, 'DISTRACTOR_BRAZIL_ITALY_SOURCES.md'),
    ...
    ('distractor-era-gaps.json', 2, 'DISTRACTOR_ERA_GAPS_SOURCES.md'),
    ...
    ('distractor-figo-era.json', 2, 'DISTRACTOR_FIGO_ERA_SOURCES.md'),
    ('distractor-roster-batch7-gaps.json', 6, 'DISTRACTOR_ROSTER_BATCH7_GAPS_SOURCES.md'),
]
bank = []
