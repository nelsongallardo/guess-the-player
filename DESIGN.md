...
## Game contract
- Shuffle a 30-player deck without replacement; an explicit end-of-deck recap and play-again action follows round 30.
...
## Verification matrix
1. Data: exactly 30 unique player IDs/names; continent count 15/15; sources for every entry; all ordered club names mapped to valid crest bytes; no national-team nodes; every pool has four or more distinct incorrect names excluding the answer.
