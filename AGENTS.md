...
- Preserve keyboard operation, focus management, visible focus styles, live feedback, reduced-motion support and mobile touch targets. At widths of 800px and below, show every club in a chronological four-column grid without horizontal scrolling; decorative `.club-step` numbers are hidden there. Keep each club's crest, tags and revealed years visually grouped in its own card. Desktop retains horizontal timeline navigation.
