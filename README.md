...
- 210 playable careers: 105 representing European national teams and 105 representing South American national teams — this number grows with each research batch; [research and audit](DATA_AUDIT.md) document every expansion and its evidence, and the footer of the app itself always shows the current total.
