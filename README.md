...
- Within compatible origins, rank by era, opening club, shared clubs, playing role and national team. Hard keeps top-eight variety without sampling away stronger origin matches. Rival names may come from outside the selected competition rather than introduce obvious giveaways. Sparse origin pools widen to the same region, retaining all closer matches first. Identical ordered careers remain excluded. See [the origin-first decision](docs/adr/0002-origin-first-distractors.md) for the exact algorithm and roster limits.
