async page => {
  ...
  for(let i=0;i<70;i++){
    ...
    ok(await page.locator('#next-label').textContent()===(i===69?'Ver resultados':'Siguiente jugador'),'Spanish next/results');
    await page.locator('#next').click();
  }
  ok(seen.size===70,'Spanish all70 deck');ok((await page.locator('#summary-caption').textContent()).includes('35 / 70 jugadores acertados'),'Spanish recap');
