...
SUITES = ['browser-checks.js', 'offline-checks.js', 'mobile-language-checks.js', 'difficulty-checks.js', 'expansion-checks.js', 'brand-checks.js', 'origin-checks.js', 'saved-rivals-checks.js', 'seo-checks.js', 'analytics-checks.js', 'guest-session-checks.js', 'accounts-checks.js']
