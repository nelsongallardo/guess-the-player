...
for filename in (['offline-checks.js'] if args.offline_only else ['browser-checks.js', 'offline-checks.js', 'mobile-language-checks.js', 'difficulty-checks.js', 'expansion-checks.js', 'brand-checks.js', 'origin-checks.js', 'saved-rivals-checks.js']):
