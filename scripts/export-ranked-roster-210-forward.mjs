// Generate the reviewed 160→210 forward roster migration without rewriting frozen history.
...
assert.equal(roster.length, 210, 'reviewed playable roster');
...
const sql = `-- Generated forward roster migration from the reviewed 210-player runtime model.\n` +
...
if (process.argv.includes('--check')) {
  assert.equal(fs.readFileSync(migration, 'utf8'), sql, '210-player forward ranked roster migration is stale; regenerate and review');
} else {
